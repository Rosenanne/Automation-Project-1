...
describe('Input fields', () => {
    it('1. Username cannot be empty string', () => {
    ...
    it('2. Username tooltip is visible', () => {
        // get username input field
    ...
    it('3. Username should have min and max length values 1 and 50 characters', () => {
    ...
    it('4. Username should support only lower letters and numbers', () => {
        // check with regex supporter format
        cy.get('#username').should('have.attr', 'pattern', '[a-zA-Z0-9_]+')
    })

    it('5. Email input should support correct pattern', () => {
        // Check regex
        // input invalid email
    ...
    it('6. User cannot submit empty registration form', () => {
        // Do not add any information
        // Check that submit button is not enabled
        cy.get('.submit_button').should('not.be.enabled');
    })

    it('7. BMW should not be listed in cars list', () => {
